...
import { XIcon, SearchIcon, CheckIcon, PackageIcon } from './icons/Icons';
...
const CreateBundleModal: React.FC<CreateBundleModalProps> = ({ isOpen, onClose, onSave, userPrompts }) => {
  ...
  const handleSave = () => {
    ...
    onSave({
      ...
      coverImage: coverImage.trim() || `https://picsum.photos/seed/bundle-${Date.now()}/400/250`,
